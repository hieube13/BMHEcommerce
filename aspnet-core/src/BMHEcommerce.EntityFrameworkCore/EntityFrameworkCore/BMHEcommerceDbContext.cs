...
using BMHEcommerce.Inventories;
...
using BMHEcommerce.Configurations.IdentitySettings;
...
public class BMHEcommerceDbContext :
    AbpDbContext<BMHEcommerceDbContext>,
    IIdentityDbContext,
    ITenantManagementDbContext
{
    ...
    public BMHEcommerceDbContext(DbContextOptions<BMHEcommerceDbContext> options)
        : base(options)
    {
